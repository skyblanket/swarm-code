...
reported to the project maintainers privately — open a report via the
repository's **Security** tab (private vulnerability report) or contact the
repository owner through their GitHub profile. All complaints will be reviewed
...
1. **Correction** — a private, written warning for unprofessional or unwelcome
   behavior, with clarity about the violation.
2. **Warning** — consequences for continued behavior; no interaction with the
   people involved for a specified period.
